...
extern "C" {
  ...
  extern const char *track_format_mode2str[9];
...
#define CDIO_CD_MIN_TRACK_NO  1 /**< Smallest CD track number */
  ...
  */
  ...
  /*!
    Get the mode (audio, mode2, mode1) of track.
  */
  trackmode_t cdio_get_track_mode(const CdIo_t *p_cdio, track_t i_track);
  ...
  */
  ...
  /*!
    Return the number of sectors in this track.
    0 is returned if there is an error.
  */

  unsigned int cdio_get_track_end_sector(const CdIo_t *p_cdio, track_t u_track);
